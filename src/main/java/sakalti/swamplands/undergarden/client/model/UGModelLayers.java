...
public class UGModelLayers {
	...
	private static ModelLayerLocation register(String name) {
		return new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Undergardens.MODID, name), "main");
	}

	private static ModelLayerLocation register(String name, String layerName) {
		return new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Undergardens.MODID, name), layerName);
	}
}